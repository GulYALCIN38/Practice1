...
// Kitapcı_KitapEkle kitap = new Kitapcı_KitapEkle();
    static LinkedHashMap<Integer,Kitapbilgi> kutuphane=new LinkedHashMap<>();
   static Set<Map.Entry<Integer,Kitapbilgi>> entries= kutuphane.entrySet();
    ...
    private static void numaraIleKitapGor(){
